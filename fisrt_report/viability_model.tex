...
\centering
    \begin{minipage}[b]{0.4\textwidth}
    \centering
    \includegraphics[scale=0.2,angle=0]{4Grouting.jpg}
    ...
    \begin{minipage}[b]{0.45\textwidth}
    \centering
    \includegraphics[scale=0.3,angle=0]{raspeberry.jpg}
...
Considering this it can be supposed that the cable has a little effect on the boat (as long as it is not heavy)
